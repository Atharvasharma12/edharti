...
// $filesize=filesize("file");
 ...
 $r=(rand(1,100));
 $_SESSION["r"] = "$r";
 $filenamewith_r=$without_extension.''.$r;
  $uploadfilename=$without_extension.''.$r.''.$dot.''.$file_extension ;
  
  $_SESSION["uploadfilename"] = "$uploadfilename";
  $_SESSION["filenamewith_r"] = "$filenamewith_r";
 $location = './zip_shape/' . $uploadfilename;  
...
echo '<script>window.location.href = "complete_unzip.php";</script>';
