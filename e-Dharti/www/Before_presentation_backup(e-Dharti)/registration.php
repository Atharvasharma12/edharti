...
if(isset($_GET["submit"]))
	{	
     ...
     { 
	 $query = "INSERT INTO registration (fullname,email,password,organizationname,role,workspacesatus,firstname,lastname,workspace_id) VALUES ('".$fullname."','".$email."','".$password."','".$organizaname."','".$role."','0','".$fname."','".$lname."','".$workspace_id."')"; 
