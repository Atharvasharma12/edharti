		...
		<header id="fh5co-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					...
					<img src="images/logo.png" style="width:50px;height:50px;">e - Dharthi...</a></h1>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal" style="background-color:#F78536;color:white;">Close</button>
			...
			<div class="container">
               ...
               <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="background-color:#F78536"><i class="fa fa-plus" style="margin-right:5px;"></i> Create New Application</button>
