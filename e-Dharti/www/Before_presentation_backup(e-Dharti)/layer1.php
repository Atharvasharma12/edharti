...
$_SESSION["filenamewith_rr"] = "$filenamewith_rr";
 ...
 $ch = curl_init();
	...
	//feature	
	 curl_setopt($ch, CURLOPT_URL, "http://localhost:8000/geoserver/rest/workspaces/$workspace/datastores/$dnames/featuretypes/");	
...
curl_setopt($ch, CURLOPT_HEADER, 0);
    ...
    $xmlStr2 = "<featureType><name>$filenamewith_rr</name></featureType>";
