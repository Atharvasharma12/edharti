...
//echo $ff;
$command="C:/OSGeo4W64/bin/ogr2ogr.exe -f \"ESRI shapefile\" C:/wamp64/www/PEOPLE-MAP/upload/$ff C:/wamp64/www/PEOPLE-MAP/upload/$inputfile";
shell_exec($command);


$a=".vrt";
$filepath="C:/wamp64/www/PEOPLE-MAP/upload/$without_extension";
$myfile = fopen($filepath.''.$a, "w") or die("Unable to open file!");
$txt = "<OGRVRTDataSource>
  <OGRVRTLayer name=$without_extension>
    <SrcDataSource>C:/wamp64/www/PEOPLE-MAP/upload/$inputfile</SrcDataSource>
