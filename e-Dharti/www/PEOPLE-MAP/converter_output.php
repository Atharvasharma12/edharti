  ...
  <table class="table" id="myTable">
    ...
    <tbody>
      <tr>
        ...
        <td>35</td>
        <td>New</td>
        <td><i class="fa fa-download" style="color:DodgerBlue;font-size:20px";><input type="button" class="bt"  ></i><button onclick="deleteRow(this)" class="bt"><i class="fa fa-trash-o" style="font-size:20px;color:red"></i></i></button>
